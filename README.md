...
graph TD
    ...
    D --> D1[Подшард 1<br/>user_id % 3 = 0]
    D --> D2[Подшард 2<br/>user_id % 3 = 1]
    D --> D3[Подшард 3<br/>user_id % 3 = 2]
    
    C --> E[Шард «книги»]
    E --> E1[Подшард 1<br/>жанр A–M]
    E --> E2[Подшард 2<br/>жанр N–Z]
    
    C --> F[Шард «магазины»]
    F --> F1[Подшард 1<br/>регион 1]
    F --> F2[Подшард 2<br/>регион 2]
    F --> F3[Подшард 3<br/>регион 3]
    F --> F4[Подшард 4<br/>регион 4]
